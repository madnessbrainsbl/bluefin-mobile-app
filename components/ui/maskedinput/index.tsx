...
// import { Input, InputIcon, InputSlot } from "../input";

// // const StyledMaskedTextInput = styled(
// //     MaskedTextInput, // imported from react-native-mask-text
// //     {...},
// //   );
  
//   export const MaskedInput = createInput({
//     Root: Input,
//     Icon: InputIcon,
...
const UIInput = createInput({
  Root: withStyleContextAndStates(InputWrapper, SCOPE),
  Icon: PrimitiveIcon,
  Slot: Pressable,
  Input: withStates(MaskedTextInput),
});

const inputStyle = tva({
  base: 'border-outline-main flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-main data-[focus=true]:hover:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-outline-light items-center',
...
Input.displayName = 'MaskedInput';
InputIcon.displayName = 'MaskedInputIcon';
InputSlot.displayName = 'MaskedInputSlot';
InputField.displayName = 'MaskedInputField';

export { Input as MaskedInput, InputField as MaskedInputField, InputIcon as MaskedInputIcon, InputSlot as MaskedInputSlot };
