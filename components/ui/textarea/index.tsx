...
const textareaStyle = tva({
  base: 'w-full h-[100px] border border-outline-main rounded data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-main data-[focus=true]:data-[hover=true]:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:bg-background-50 data-[disabled=true]:data-[hover=true]:border-background-300',
