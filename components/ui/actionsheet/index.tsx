...
const actionsheetContentStyle = tva({
  base: 'items-center rounded-tl-3xl rounded-tr-3xl p-5 pt-2 bg-background web:pointer-events-auto web:select-none shadow-hard-5 border border-b-0 border-outline-main',
});
...
const actionsheetDragIndicatorStyle = tva({
  base: 'w-16 h-1 bg-typography-control rounded-full',
});
...
const actionsheetBackdropStyle = tva({
  base: 'absolute left-0 top-0 right-0 bottom-0 bg-surface-dark web:cursor-default web:pointer-events-auto',
});
