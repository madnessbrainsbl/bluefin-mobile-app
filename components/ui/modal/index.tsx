...
const modalBackdropStyle = tva({
  base: 'absolute left-0 top-0 right-0 bottom-0 bg-surface-dark web:cursor-default',
});

const modalContentStyle = tva({
  base: 'bg-background rounded-md overflow-hidden border border-outline-light shadow-hard-2 p-6',
  parentVariants: {
    size: {
      xs: 'w-[60%] max-w-[360px]',
      sm: 'w-[70%] max-w-[420px]',
