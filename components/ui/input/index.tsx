...
const createTextInput = (TextInputComponent: React.ComponentType<any>) => {
  const SCOPE = "INPUT";
  ...
  const inputStyle = tva({
    base: "flex-row content-center items-center overflow-hidden border-outline-main data-[focus=true]:border-primary-main data-[focus=true]:hover:border-primary-700 data-[hover=true]:border-outline-400 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300",
...
const { Input, InputField, InputIcon, InputSlot } = createTextInput(TextInput);
const {
  Input: MaskedInput,
  InputField: MaskedInputField,
  InputIcon: MaskedInputIcon,
  InputSlot: MaskedInputSlot,
} = createTextInput(MaskedTextInput);
